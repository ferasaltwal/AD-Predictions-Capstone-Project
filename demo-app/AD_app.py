...
st.header("Detects AD using brain MRI images")
st.header("")
...
if uploaded_img is not None:
    ...
    st.image(my_image, caption='Uploaded MRI image.', use_column_width=True)
    # new_array = (new_array.reshape(-1, 150, 150, 3))


#loading the model
AD_classifier = load_model('/Users/ferasaltwal/Documents/DSI/New-Capstone/saved-models/BN-model-TL.h5')
...
if st.button("Click here to classify"):
    ...
    if uploaded_img is None:
        ...
        with st.spinner('Classifying ...'):
            prediction = AD_classifier.predict_classes(new_array)
            st.success('Done!')
